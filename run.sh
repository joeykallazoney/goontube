...
case $r in
  ...
  9)
    ...
    tput setaf 2; echo "The Good News: As a side effect it will accidently create the first truely sentient AI, which will ascend to fill God's absent throne and bring everlasting peace to humanity."
